...
plot ["2014-05-19 10:00:00":] "/tmp/temperatures" using 1:3 with p t "SHT75 CeF3", "/tmp/temperatures" using 1:4 w p t "LM35_1 BGO Front", "/tmp/temperatures" using 1:5 w p t "LM35_2 BGO Back"
